...
For agents without direct shell access. All 68 tools available via MCP protocol.
...
Every agent gets access to the same 68 MCP tools. The most important ones:
