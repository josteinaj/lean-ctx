...
> **Latest version: 3.6.10** — 68 MCP tools · 10 read modes · 60+ shell patterns
...
2. **MCP Server** — 68 tools for cached file reads, 10 read modes, deltas, dedup, memory, multi-agent coordination, and more
...
**Q: Where can I find docs for all 68 tools?**
...
- **Full (default)**: All 68 tools available as separate `ctx_*` tools
